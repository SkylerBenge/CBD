...
var ajaxCart = (function(module, $) {
  ...
  buildCart = function (cart) {
    ...
    var cartTotalRaw = cart.total_price/100;
    if(cartTotalRaw >= 50){
      //console.log('more');
      var msg = 'Yay! you qualify for free shipping';
    } else {
      var cartDelta = 50 - cartTotalRaw;
      var msg= 'You are only $'+ cartDelta +' away from free shipping.';
    }
  ...
  qtySelectors = function() {
    ...
    if (numInputs.length) {
      ...
      $('.js-qty__adjust').on('click', function(event) {
		...
		// reload form when either plus or minus quantity button is clicked    
        $(this.form).attr("action", "/cart");
        //$(this.form).submit();
      });
    }
  };
